			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="assets.html"><i class="fas fa-cube"></i> <span>Assests</span></a> </li>
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">Assests</h4> <a href="add-asset.html" class="btn btn-primary float-right veiwbutton">Add Assests</a> </div>
						</div>
					</div>
				</div>
				<div class="row">
