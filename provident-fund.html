...
<a href="add-provident-fund.html" class="btn btn-primary float-right veiwbutton">Add
Provident Fund</a>
</div>
</div>
</div>
...
<a class="dropdown-item" href="edit-provident-fund.html"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
