...
<a href="add-expense.html" class="btn btn-primary float-right veiwbutton">Add
expense</a>
</div>
</div>
</div>
...
<a class="dropdown-item" href="edit-expense.html"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
