...
<a href="add-tax.html" class="btn btn-primary float-right veiwbutton">Add Tax</a>
</div>
</div>
</div>
</div>
...
<a class="dropdown-item" href="edit-tax.html"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
