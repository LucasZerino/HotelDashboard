								...
								<ul class="activity-list">
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile.html" title="Lesley Grauer" data-toggle="tooltip" class="avatar"> <img alt="Lesley Grauer" src="assets/img/profiles/avatar-01.jpg" class="img-fluid rounded-circle"> </a>
										</div>
									...
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile.html" title="Lesley Grauer" data-toggle="tooltip" class="avatar"> <img alt="Lesley Grauer" src="assets/img/profiles/avatar-02.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
											<div class="timeline-content"> <a href="profile.html" class="name">Lesley Grauer</a> added new work <a href="activities.html">For Staff</a> <span class="time">4 mins ago</span> </div>
										</div> <a class="activity-delete" href="" title="Delete">&times;</a> </li>
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile.html" title="Catherine Manseau" data-toggle="tooltip" class="avatar"> <img alt="Catherine Manseau" src="assets/img/profiles/avatar-03.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
									...
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="#" title="Bernardo Galaviz" data-toggle="tooltip" class="avatar"> <img alt="Bernardo Galaviz" src="assets/img/profiles/avatar-04.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
									...
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile.html" title="Mike Litorus" data-toggle="tooltip" class="avatar"> <img alt="Mike Litorus" src="assets/img/profiles/avatar-05.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
									...
									<li class="activity-list_li">
										<div class="activity-user">
											<a href="profile.html" title="Jeffery Lalor" data-toggle="tooltip" class="avatar"> <img alt="Jeffery Lalor" src="assets/img/profiles/avatar-06.jpg" class="img-fluid rounded-circle"> </a>
										</div>
										<div class="activity-content">
