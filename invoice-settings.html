...
<ul>
<li>
<a href="index.html"><i class="fe fe-home"></i> <span>Back to Home</span></a>
</li>
<li>
...
<li>
<a href="roles-permissions.html"><i class="fe fe-vector"></i> <span>Roles &
Permissions</span></a>
</li>
<li>
...
<li>
<a href="notifications-settings.html"><i class="fe fe-warning"></i> <span>Notifications</span></a>
</li>
<li>
...
<div class="col">
<h3 class="page-title mt-5">Invoice Settings</h3>
</div>
</div>
</div>
<div class="row">
...
<input class="form-control" type="text" value="HOTEL-Admin">
</div>
</div>
<div class="col-md-4">
<div class="form-group">
